...
class Settings:
    ...
    cognitive_model: str = field(default_factory=lambda: os.getenv("COGNITIVE_MODEL", ""))
    cognitive_base_url: str = field(default_factory=lambda: os.getenv("COGNITIVE_BASE_URL", ""))
